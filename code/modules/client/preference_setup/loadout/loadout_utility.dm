...
/datum/gear/utility/guns
	display_name = "firearm selection"
	description = "A selection of literal (note : not metaphorical) firearms."
	path = /obj/item/gun
	cost = 1
...
/datum/gear/utility/guns/New()
	..()
	var/list/guns = list()
	guns["silenced 9mm pistol"] = /obj/item/gun/projectile/silenced
	guns[".38 revolver"] = /obj/item/gun/projectile/revolver/detective
	guns["9mm concealable pistol"] = /obj/item/gun/projectile/pistol
	guns["grapeshot .38 revolver"] = /obj/item/gun/projectile/revolver/lemat
	guns[".45 pistol"] = /obj/item/gun/projectile/colt
