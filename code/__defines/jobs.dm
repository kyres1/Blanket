...
#define INDEP_ROLES list(/datum/job/merchant, /datum/job/visitor, /datum/job/consular, /datum/job/journalist, /datum/job/assistant, /datum/job/patron_vip, /datum/job/patron, /datum/job/rezz_staff, /datum/job/rezz_boss, /datum/job/nonaffiliate)
